...
The workshop material is hosted on its dedicated [Github repository](https://github.com/ikmb/nfdi4microbiota_kmc_microbiome_workshop).
...
::::: columns
::: {.column .text-center width="33%"}
[![](img/nfdi4microbiota_Logo_new.png){alt="NFDI4Microbiota Logo"}](https://nfdi4microbiota.de/)
:::
::: {.column .text-center width="34%"}
[![](img/logo_miTarget_2023-extd.png){alt="miTarget Logo"}](https://www.mitarget.org/)
:::
::: {.column .text-center width="33%"}
[![](img/KLS_logo.png){alt="KLS Logo"}](https://www.uni-kiel.de/de/forschung/forschungsschwerpunkte/kiel-life-science)
:::
:::::