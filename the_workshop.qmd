...
The files need to be downloaded at (`inputs/metagenome/`) & unzipped before you start the metagenome tutorial.
...
> Note: You can get this file by clicking this [link](https://data.gtdb.ecogenomic.org/releases/release220/220.0/bac120_metadata_r220.tsv.gz)
